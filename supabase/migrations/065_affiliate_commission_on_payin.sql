-- 065: Fix affiliate commission on payin completion
-- Add affiliate credit call to complete_payin function
...
BEGIN
  ...
  -- Credit affiliate if trader has one linked (ONLY for payins)
...
-- Also update the 2-arg overload
CREATE OR REPLACE FUNCTION complete_payin(
  p_payin_id UUID,
  p_trader_id UUID
)
